...
type CetOrderRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CetOrderRequest) Reset() {
	*x = CetOrderRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CetOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CetOrderRequest) ProtoMessage() {}

func (x *CetOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orders_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CetOrderRequest.ProtoReflect.Descriptor instead.
func (*CetOrderRequest) Descriptor() ([]byte, []int) {
...
var file_orders_proto_rawDesc = []byte{
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x11, 0x0a, 0x0f, 0x43, 0x65, 0x74, 0x4f, 0x72,
	...
	,
...
var file_orders_proto_goTypes = []interface{}{
	...
	(*CetOrderRequest)(nil),     // 3: orderspkg.CetOrderRequest
...
var file_orders_proto_depIdxs = []int32{
	...
	3, // 2: orderspkg.OrderService.GetOrder:input_type -> orderspkg.CetOrderRequest
	2, // 3: orderspkg.OrderService.CreateOrder:output_type -> orderspkg.CreateOrderResponse
	4, // 4: orderspkg.OrderService.GetOrder:output_type -> orderspkg.GetOrderResponse
